...
class Face_keypointLoader(object):
    '''
    this class is made for the easy of use of getting number of images,and keypoints
    getting the keypoints and images
...
class Preprocess(Face_keypointLoader):
      ...
      def Crop(self,input_,crop = (None,None),is_image = False, is_keypoint = False):
            if is_image:
